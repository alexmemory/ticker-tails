...
const rawHoldings = [
  {
    ...
    x: 82,
    y: 39,
    pen: { x: 1060, y: 390, width: 470, height: 240 },
    anchor: { x: 1288, y: 515 },
    station: { x: 1428, y: 466 },
  ...
  },
  {
    ...
    x: 20,
    y: 47,
    pen: { x: 120, y: 150, width: 470, height: 240 },
    anchor: { x: 350, y: 276 },
    station: { x: 222, y: 228 },
  ...
  },
  {
    ...
    x: 50,
    y: 20,
    pen: { x: 1060, y: 150, width: 470, height: 240 },
    anchor: { x: 1295, y: 258 },
    station: { x: 1410, y: 190 },
    stationKind: 'library loft antenna',
    home: 'Cloud Library Loft',
    careAction: 'Tune the library loft antenna',
    need: 'Cloud scan',
    behavior: 'Reads from its library loft, then launches over neighboring paddocks before returning to its book-lined perch.',
  ...
  },
  {
    ...
    x: 30,
    y: 34,
    pen: { x: 590, y: 150, width: 470, height: 240 },
    anchor: { x: 825, y: 274 },
    station: { x: 690, y: 224 },
    stationKind: 'charger',
  ...
  },
  {
    ...
    x: 67,
    y: 41,
    pen: { x: 120, y: 390, width: 470, height: 240 },
    anchor: { x: 350, y: 515 },
    station: { x: 222, y: 470 },
  ...
  },
  {
    ...
    x: 76,
    y: 63,
    pen: { x: 590, y: 390, width: 470, height: 240 },
    anchor: { x: 825, y: 515 },
    station: { x: 690, y: 468 },
...
export const cashReserve = {
  ...
  x: 48,
  y: 76,
  pen: { x: 120, y: 630, width: 1410, height: 170 },
  anchor: { x: 825, y: 718 },
  station: { x: 930, y: 688 },
...
const neighborSlots = [
  {
    pen: { x: 120, y: 150, width: 705, height: 240 },
    anchor: { x: 470, y: 276 },
    station: { x: 272, y: 228 },
  },
  {
    pen: { x: 825, y: 150, width: 705, height: 240 },
    anchor: { x: 1175, y: 274 },
    station: { x: 978, y: 224 },
  },
  {
    pen: { x: 120, y: 390, width: 705, height: 240 },
    anchor: { x: 470, y: 515 },
    station: { x: 272, y: 470 },
  },
  {
    pen: { x: 825, y: 390, width: 705, height: 240 },
    anchor: { x: 1175, y: 515 },
    station: { x: 978, y: 470 },
  },
  {
